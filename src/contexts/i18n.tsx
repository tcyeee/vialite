...
const MESSAGES = {
  ...
  fullscreenPreviewPullExit: { en: "Keep scrolling to exit", zh: "继续下滑退出" },
  ...
  keycapColorTitle: { en: "Keycap coloring", zh: "键帽上色" },
  keycapColorButton: { en: "Paint", zh: "上色" },
  keycapColorNone: { en: "None yet", zh: "暂无" },
  keycapColorManagerTitle: { en: "Color management", zh: "颜色管理" },
  keycapColorManagerHint: {
    en: "Pick a color below, then click keycaps on the board above to paint them.",
    zh: "选择颜色后,点击上方键盘的按键即可上色。",
  },
  keycapColorAdd: { en: "Add color", zh: "新增颜色" },
  keycapColorEraser: { en: "Eraser", zh: "橡皮擦" },
  ...
  preview3dParams: { en: "Debug parameters", zh: "调试参数" },
  preview3dParamsHint: {
  ...
  preview3dGroupCap: { en: "Keycap", zh: "键帽" },
  preview3dGroupCase: { en: "Case", zh: "外壳" },
  preview3dGroupLight: { en: "Lighting", zh: "灯光" },
  ...
  previewMode: { en: "Feature preview", zh: "功能预览" },
