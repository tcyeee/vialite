...
export function MacroPanel({ keyboard, onChange }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* daisyUI official reference example — radio tabs-lift with icons + tab content, for visual comparison only */}
      <div className="tabs tabs-lift">
        <label className="tab">
          <input type="radio" name="daisyui_ref_tabs" />
          <svg
        ...
        <label className="tab">
          <input type="radio" name="daisyui_ref_tabs" defaultChecked />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
